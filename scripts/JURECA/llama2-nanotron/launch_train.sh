...
#SBATCH --time=0-04:00:00          # total run time limit (HH:MM:SS)
#SBATCH --ntasks-per-node=1
#SBATCH --partition=dc-gpu
#SBATCH --qos=normal                   #default
#SBATCH --account=jureap128
...
export CUDA_VISIBLE_DEVICES=0,1,2,3 # Needed manually on JURECA right now
...
PROGRAM="run_train.py --config-file configs/llama_2b_hplt_sv.yaml"
