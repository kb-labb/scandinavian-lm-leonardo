...
cmd="python /workspace/nemo/examples/nlp/language_modeling/megatron_bert_pretraining.py  \
    --config-path=/leonardo_work/EUHPC_D07_027/scandinavian-lm/faton/scandinavian-lm-leonardo/configs/bert-large \
    --config-name=megatron.bert-large.unigram-64k-pretok-small_data.tinystories.config.yaml \
